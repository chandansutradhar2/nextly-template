        ...
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            <h1 className="text-4xl font-bold leading-snug tracking-tight text-gray-800 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
              <span className="text-yellow-300">Learn Anytime</span>, Anywhere
            </h1>
            <p className="py-5 text-sm leading-normal text-gray-500 lg:text-xl xl:text-xl dark:text-gray-300">
              Unleash your web development expertise! 17+ years of industry
              mastery brought to life in our interactive and fun courses. Learn
              everything you need to know to become a web developer without ever
              getting bored. Embrace the latest technologies with us and embark
              on an energetic journey to web development success!
            </p>
            ...
            <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              <a
                ...
                target="_blank"
                rel="noopener"
                className="shadow-xl shadow-indigo-300 px-8 py-4 text-lg font-medium text-center
                 text-white bg-indigo-600 rounded-md hover:bg-yellow-300 hover:text-slate-800 hover:shadow-yellow-200">
                Subscribe Now
              </a>
              <a
